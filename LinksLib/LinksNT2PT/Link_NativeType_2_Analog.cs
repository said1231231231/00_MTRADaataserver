...
{
    public class Link_NativeType_2_Analog : LinkNT2PTBase
    {
        public Link_NativeType_2_Analog(DataConfiguration dcNC, _01Configuration dcPL)
            : base(dcNC, dcPL)
        {
        }
        /// <summary>
        ...
        /// <param name="dt"></param>
        protected override void ReNewPTValue()//object valueNT, ProjectCommonData.VarQuality varqualityNT, DateTime dtNT
        {
            //if (valueNT == null)
            //    return;
            if (TagValueNT == null)
            ...
            {
                // значение
                TagValuePL = Convert.ToSingle(TagValueNT) * TransformationRatioPL;//valueNT
                ////качество и время
