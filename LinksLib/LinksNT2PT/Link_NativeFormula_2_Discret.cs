 ...
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *                                                                             
 *Описание: Link_NativeFormula_2_Discret - класс реалзизации канала преобразования формулы Native в тип Discret
 *                                                                             
 *Файл                     : X:\Projects\00_MTRADataServer\LinksLib\LinksNT2PT\Link_NativeFormula_2_Discret.cs
 *Тип конечного файла      :                                         
...
{
    public class Link_NativeFormula_2_Discret : Link_NatimeFormula
    {
        public Link_NativeFormula_2_Discret(DataConfiguration dcNC, _01Configuration dcPL)
            : base(dcNC, dcPL)
        {
        }
        /// <summary>
        ...
        public override void InitParser(string s, SortedList<string, string> slGlobalListTagsType, string UniDS_GUID, string UniDev_GUID)
        {
            ...
            try
            {
                Expression.Parser parser = new Expression.Parser(s, "Discret", slGlobalListTagsType, UniDS_GUID, UniDev_GUID);
                expr = parser.Parse();
            }
            catch (Exception ex)
            {
