...
{
    public class LinkHT2NT_DateTime4_FieldMT_2_DateTime : LinkHT2NT_MOA_ECU
    {
        public LinkHT2NT_DateTime4_FieldMT_2_DateTime(DataConfigurationHardware dchHC, DataConfiguration dcNC)
            : base(dchHC, dcNC)
        {
        }
