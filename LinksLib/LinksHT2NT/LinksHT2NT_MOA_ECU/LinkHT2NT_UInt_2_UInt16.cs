 ...
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *                                                                             
 *Описание: LinkHT2NT_UInt_2_UInt16 -  - класс для конкретизации действий по преобразованию значения hardware в значение типа c#
 *                                                                             
 *Файл                     : X:\Projects\00_MTRADataServer\MTRADataServer\LinksHT2NT\LinksHT2NT_MOA_ECU\LinkHT2NT_UInt_2_UInt16.cs
 *Тип конечного файла      :                                         
...
{
    public class LinkHT2NT_UInt_2_UInt16 : LinkHT2NT_MOA_ECU
    {
        public LinkHT2NT_UInt_2_UInt16(DataConfigurationHardware dchHC, DataConfiguration dcNC)
            : base(dchHC, dcNC)
        {
        }
        ...
        protected override void ReNewNTValue(object valueHT, ProjectCommonData.VarQuality varqualityHT, DateTime dtHT)
        {
            if (valueHT == null)
             ...
             try
             {
                 ...
                 TagValueNT = BitConverter.ToUInt16(valueHT as byte[], 0);
                 //качество и время
